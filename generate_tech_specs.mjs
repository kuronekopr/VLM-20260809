...
const outputPath = path.join(process.cwd(), 'technical_spec_aircon_daikin.json');
fs.writeFileSync(outputPath, JSON.stringify(technicalSpecifications, null, 2), 'utf8');
console.log(`Successfully generated technical_spec_aircon_daikin.json with ${technicalSpecifications.length} Daikin tech spec models.`);
