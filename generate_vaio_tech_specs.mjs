...
// VAIO ノートパソコン 標準仕様一覧データ (仕様一覧① P.25-26 ＆ 仕様一覧③ P.29-30)
const vaioTechSpecs = [
    {
        manufacturer: "VAIO",
        ...
        model_numbers: [
            "VJS14R19011B", "VJS14R19021B", "VJS14R19031B", "VJS14R19041T", "VJS14R19051G", "VJS14R19061S",
            "VJS14R295101B", "VJS14R295102G", "VJS14R295103R", "VJS14R295104G"
        ],
    ...
    },
    {
        ...
        model_numbers: [
            "VJS13690111B", "VJS13690211T", "VJS13690311B", "VJS13690411T"
        ],
        os: ["Windows 11 Pro 64ビット"],
        cpu_options: [
            "インテル® Core™ 7 プロセッサー 150U (10コア/12スレッド, TDP 15W)",
            "インテル® Core™ 5 プロセッサー 120U (10コア/12スレッド, TDP 15W)"
        ],
        display: {
            size: "13.3型ワイド",
            aspect_ratio: "16:10",
        ...
        memory: "16GB (増設不可)",
        storage: "スタンダードSSD (NVMe 暗号化機能付き) 512GB / 1TB",
        camera: "92万画素",
        wireless: {
            wifi: "IEEE 802.11a/b/g/n/ac/ax準拠, Wi-Fi 6E適合, WPA3対応",
            bluetooth: "Bluetooth® 5.3準拠"
        },
        interfaces: [
            "USB Type-C×2 (USB Power Delivery, USB 3.1, DisplayPort 1.4)",
            "USB 3.0×2",
            "HDMI (出力)×1"
        ],
        keyboard_touchpad: "キーピッチ約19mm, キーストローク約1.5mm, テンキー無, 高精度タッチパッド (ジェスチャー機能, 2ボタン付き)",
        biometrics: ["指紋認証", "顔認証"],
        battery_life_hours: {
            video_playback: "約8.0時間",
            idle: "約21.0時間"
        },
        dimensions_mm: {
            width: 299.3,
        ...
        bundled_office: "Office Home & Business 2024",
        warranty: "1年"
    },
    {
        manufacturer: "VAIO",
        ...
        model_numbers: [
            "VJF16297101L", "VJF16297102N", "VJF16297103S", "VJF16295104L", "VJF16295105N"
        ],
        ...
        memory: "16GB (増設不可)",
        storage: "スタンダードSSD (NVMe 暗号化機能付き) 512GB",
        camera: "92万画素",
        wireless: {
            wifi: "IEEE 802.11a/b/g/n/ac/ax準拠, Wi-Fi 6E適合, WPA3対応",
            bluetooth: "Bluetooth® 5.3準拠"
        ...
        keyboard_touchpad: "キーピッチ約19mm, キーストローク約1.5mm, テンキー有, 高精度タッチパッド (ジェスチャー機能付き), マウス有",
        biometrics: ["指紋認証", "顔認証"],
        battery_life_hours: {
            video_playback: "約6.0時間",
            idle: "約11.5時間"
        },
        dimensions_mm: {
            width: 358.3,
    ...
    },
    {
        ...
        model_numbers: [
            "VJF14297107L", "VJF14297108N", "VJF14297109S", "VJF14295110L", "VJF14295111N", "VJF14295112S"
        ],
        os: ["Windows 11 Home 64ビット"],
        cpu_options: [
            "インテル® Core™ 7 プロセッサー 150U (10コア/12スレッド, TDP 15W)",
        ...
        keyboard_touchpad: "キーピッチ約19mm, キーストローク約1.5mm, テンキー無, 高精度タッチパッド (ジェスチャー機能付き), マウス無",
        biometrics: ["指紋認証", "顔認証"],
        battery_life_hours: {
            video_playback: "約7.7時間",
            idle: "約12.5時間"
        },
        dimensions_mm: {
            width: 322.9,
